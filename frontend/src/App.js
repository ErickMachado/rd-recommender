...
function App() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col gap-5 justify-center items-center p-5">
      <div className="w-full max-w-[1280px] bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="w-full max-w-[1280px] grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <Form onRecommendationChange={setRecommendations} />
        </div>
        <div className="bg-white p-8 rounded-lg shadow-md">
